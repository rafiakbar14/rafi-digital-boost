  ...
  return (
    <>
      ...
      <section id="pricing" className="py-16 bg-gray-50">
        <div className="container max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center">Paket Web Company Profile</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <PriceCard
              ...
              ctaLink={`https://wa.me/6283135183093?text=${encodeURIComponent("Halo, saya berminat dengan paket Web Company Profile Starter. Bisa konsultasi lebih lanjut?")}`}
            />
            ...
            <PriceCard
              ...
              isPopular={true}
              ctaText="Pesan Sekarang"
              ctaLink={`https://wa.me/6283135183093?text=${encodeURIComponent("Halo, saya berminat dengan paket Web Company Profile Business. Bisa konsultasi lebih lanjut?")}`}
            />
            ...
            <PriceCard
              ...
              ctaText="Pesan Sekarang"
              ctaLink={`https://wa.me/6283135183093?text=${encodeURIComponent("Halo, saya berminat dengan paket Web Company Profile Enterprise. Bisa konsultasi lebih lanjut?")}`}
            />
          </div>
        </div>
      </section>
