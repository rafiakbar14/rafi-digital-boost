...
const WebsiteCustom = () => {
  const whatsappMessage = encodeURIComponent("Halo Saya berminat dengan Website Custom tolong bantu saya membuatnya, terima kasih 🙏");

  return (
    <>
      <Helmet>
        <title>Jasa Website Custom - Cubicin</title>
        <meta name="description" content="Jasa pembuatan website custom profesional untuk bisnis Anda. Website dengan admin dashboard dan fitur sesuai kebutuhan bisnis." />
      </Helmet>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="md:w-1/2 space-y-6">
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
                Website Custom <span className="text-brand-blue">Sesuai Kebutuhan</span> Bisnis Anda
              </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center">Fitur Website Custom</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Siap Memulai Proyek Website Custom Anda?</h2>
